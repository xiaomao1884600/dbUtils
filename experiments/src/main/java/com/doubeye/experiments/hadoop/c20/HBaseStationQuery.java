...
public class HBaseStationQuery extends Configured implements Tool{
    ...
    static final byte[] LOCATION_QUALIFIRE = Bytes.toBytes("location");
    static final byte[] DESCRIPTION_QULIFIRE = Bytes.toBytes("description");
    ...
    public Map<String, String> getStationInfo(HTable table, String stationId) throws IOException {
        ...
        resultMap.put("location", getValue(res, INFO_COLUMNFAMILY, LOCATION_QUALIFIRE));
        resultMap.put("description", getValue(res, INFO_COLUMNFAMILY, DESCRIPTION_QULIFIRE));
        return resultMap;
    }
