...
public class LoggingDriver extends Configured implements Tool {
    ...
    /**
     * hadoop jar d:\experiments.jar com.doubeye.experiments.hadoop.c06.LoggingDriver -conf conf/hadoop-cluster.xml -D mapreduce.map.log.level=DEBUG data/1901.txt logging-out
     * @param args
     * @throws Exception
     */
