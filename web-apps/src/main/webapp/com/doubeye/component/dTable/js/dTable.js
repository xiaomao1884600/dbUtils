 ...
 *  + 加入对数据的部分操作
 */
com.doubeye.dTable = com.doubeye.Ext.extend(com.doubeye.Component, {
	className : 'com.doubeye.dTable',
	/**
	 * 列定义对象
	 */
	...
	*/
	...
	/// 以下方法中都是重复状态，为了简化插件，将方法全部改为获得table然后调用方法
	/**
	 * 获得标记为删除的行
	...
	getRowsMarkDeleted : function() {
		...
		return this.getTable().__getSpecifiedStatusRows(com.doubeye.constant.DATA.RECORDSTATUS.MARKDELETED);
	},
	/**
	 * 获得新增的行
	...
	getRowsAdded : function() {
		...
		return this.getTable().__getSpecifiedStatusRows(com.doubeye.constant.DATA.RECORDSTATUS.ADDED);
	},
	/**
	 * 获得新增后被标记为删除的行 
	...
	getRowsAddedAndDeleted : function() {
		...
		return this.getTable().__getSpecifiedStatusRows(com.doubeye.constant.DATA.RECORDSTATUS.NEW_AND_DELETED);
	},
	/**
	 * 获得修改过的行
	...
	getRowsModified : function() {
		...
		return this.getTable().__getSpecifiedStatusRows(com.doubeye.constant.DATA.RECORDSTATUS.MODIFIED);
	},
	/**
	 * 获得修改后被删除的行
	...
	getRowsModifiedAndDeleted : function() {
		...
		return this.getTable().__getSpecifiedStatusRows(com.doubeye.constant.DATA.RECORDSTATUS.MODIFIED_AND_DELETE);
	},
	/**
	* 获得指定类型的行
	...
	*/
	__getSpecifiedStatusRows : function(status) {
		...
		return this.getTable().dataRows.getSpecifiedStatusRows(status);
	}
});